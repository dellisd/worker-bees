...
class BoundTestService(private val workerServiceBinding: WorkerServiceBinding<TestService>) :
  TestService {
  override suspend fun test(): String =
    workerServiceBinding.json.decodeFromJsonElement(workerServiceBinding.invoke("test"))
